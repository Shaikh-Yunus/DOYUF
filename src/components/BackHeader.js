          ...
          >
            <View style={styles.modalContent}>
              <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                ...
                <FontAwesome onPress={closeModal} name='close' color='#000' size={20} />
              </View>

              <View style={styles.buttonContainer}>
                <TouchableOpacity onPress={openloginmodel} style={styles.buttonlogin}>
                  <Text style={{ color: '#D7B97B', fontWeight: 'bold', textAlign: 'center', fontFamily: Constant.fontFamily }}>LOGIN</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={openregistrationmodel} style={styles.buttonregistor}>
          ...
          >
            <View style={styles.modalcartContent}>
              <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                ...
                <FontAwesome onPress={closecartModal} name='close' color='#000' size={20} />
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                <Text style={{ fontFamily: Constant.fontFamily, fontWeight: '700', color: '#000', fontSize: 16 }}>Subtotal</Text>
                <Text style={{ fontFamily: Constant.fontFamily, fontWeight: '700', color: '#000', fontSize: 16 }}>₹16118.53</Text>
