...
const LoginScreen = ({
  ...
  const HandleLogin = () => {
    ...
    fetch(`${Constant.BASE_URL + 'login'}`, requestOptions)
  ...
  return (
    <View style={[GlobalStyles.container, {}]}>
      <View style={{padding: 0}}>
        ...
        <TouchableOpacity
          onPress={() => {
            closeloginmodel(), openforgotPasswordmodel()
          }}>
        ...
        <View
          ...
          <TouchableOpacity
            onPress={() => {
              closeloginmodel(), openregistrationmodel();
            }}>
            <Text
        ...
        <View
          style={{backgroundColor: '#D9D9D9', height: 1, marginTop: 20}}></View>
        <Text
          style={{
