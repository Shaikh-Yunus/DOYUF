...
const CartFooter = () => {
  return (
    <View style={{
      ...
      <View style={{
        padding: 20, borderTopWidth: 0.5, borderColor: 'grey', marginTop: 10
      }}>
        ...
        <View style={[GlobalStyles.spaceBetweenRow, { marginTop: 10 }]}>
          ...
          <Text style={styles.textCartFooterBold}>₹16118.53</Text>
        </View>
      </View>
      <View style={[{
        padding: 15,
        ...
        <Text style={{
          ...
          , fontWeight: 'bold', fontSize: 20, color: Constant.colors.textColor
        }}>
          PROCEED TO CHECKOUT
        </Text>
      </View>
              ...
              <View style={{
                ...
                <View style={{}}>
                  <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                    <View style={{}}>
                      <Text style={{ marginVertical: 5, fontSize: 16, color: 'black', fontWeight: 'bold', fontFamily: Constant.fontFamily }}>
                        {item.p_name.length > 10 ? `${item.p_name.substring(0, 10)}...` : item.p_name}
                      </Text>
                    </View>
                    <View style={{ flex: 1 }}>
                      <Dropdown
                  ...
                  <View style={{ flexDirection: 'row' }}>
                    <Text style={{ marginVertical: 5, fontSize: 14, color: 'black', fontFamily: Constant.fontFamily }}>Brand: </Text>
                    <Text style={{ marginVertical: 5, fontSize: 14, color: 'black', fontWeight: 'bold' }}>{item.brand}</Text>
                  </View>
                  <Text style={{ marginVertical: 5, fontSize: 14, color: 'black', fontWeight: 'bold' }}>₹{item.price}</Text>
                </View>
              </View>
            )}
          />
